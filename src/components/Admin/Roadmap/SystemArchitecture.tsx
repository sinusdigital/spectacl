...
const ServiceCard = ({ 
    ...
    type ColorTokens = { bg: string; border: string; text: string; ring: string };
        ...
        >
            ...
            <Flex direction="column" align="center" gap="2" mt="1">
                ...
                <Box style={{ textAlign: 'center' }}>
                    <Text size="2" weight="bold" color={color === 'black' ? undefined : (color as TextColor)} style={{ color: style.text, display: 'block' }}>{title}</Text>
